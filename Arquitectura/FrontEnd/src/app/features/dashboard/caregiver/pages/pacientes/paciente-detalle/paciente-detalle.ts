...
@Component({
    selector: 'app-caregiver-paciente-detalle',
    standalone: true,
    imports: [
        CommonModule,
        RouterModule,
...
export class CaregiverPacienteDetalle implements OnInit {
    ...
    async cargarPaciente(id: number) {
        ...
        try {
            ...
            this.mostrarToast('error', 'Error', 'No se pudo cargar la informacion del paciente');
        } finally {
